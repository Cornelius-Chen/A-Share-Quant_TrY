...
- Expected Benefits: Further reduce the chance that the repo confuses “mechanism repeats” with “mechanism necessarily causes pnl damage.”
- Risks: Even three symbols are still not enough to claim a final structural rule; the repo should continue to treat this as diagnosis, not promotion evidence.
