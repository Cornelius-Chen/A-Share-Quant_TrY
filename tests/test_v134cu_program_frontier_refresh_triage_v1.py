...
def test_v134cu_program_frontier_refresh_triage_v1() -> None:
    ...
    assert result.summary["authoritative_status"] == "program_view_refreshed_reduce_frozen_intraday_add_deferred"
