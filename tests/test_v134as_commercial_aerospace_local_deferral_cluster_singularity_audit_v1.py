...
def test_v134as_commercial_aerospace_local_deferral_cluster_singularity_audit_v1() -> None:
    ...
    assert payload["summary"]["reversal_session_count"] >= 10
    assert payload["summary"]["matched_local_deferral_count"] >= 1
