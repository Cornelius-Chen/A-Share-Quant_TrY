...
from a_share_quant.strategy.v123b_cpo_1min_orthogonal_downside_time_split_audit_v1 import (
    V123BCpo1MinOrthogonalDownsideTimeSplitAuditAnalyzer,
)


def test_v123b_time_split_stays_above_random() -> None:
    ...
    result = V123BCpo1MinOrthogonalDownsideTimeSplitAuditAnalyzer(repo_root=repo_root).analyze()
