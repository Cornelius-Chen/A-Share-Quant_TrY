...
def test_v134au_commercial_aerospace_post_exit_rebound_pattern_audit_v1() -> None:
    ...
    assert payload["summary"]["remaining_rebound_case_count"] >= 1
    assert payload["summary"]["dominant_pattern"] != ""
