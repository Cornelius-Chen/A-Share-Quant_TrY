...
def test_v112bi_ranker_pilot_produces_no_leak_portfolio_trace() -> None:
    analyzer = V112BICPOCrossSectionalRankerPilotAnalyzer()
    result = analyzer.analyze(
        phase_charter_payload=load_json_report(Path("reports/analysis/v112bi_phase_charter_v1.json")),
    ...
    assert result.summary["equity_curve_point_count"] > 0
