...
from a_share_quant.strategy.v114b_cpo_add_reduce_risk_acceptable_refinement_v1 import (
    ...
    write_v114b_cpo_add_reduce_risk_acceptable_refinement_report,
)
...
def main() -> None:
    ...
    output_path = write_v114b_cpo_add_reduce_risk_acceptable_refinement_report(
        reports_dir=repo_root / "reports" / "analysis",
        report_name="v114b_cpo_add_reduce_risk_acceptable_refinement_v1",
        result=result,
    )
    print(output_path)
