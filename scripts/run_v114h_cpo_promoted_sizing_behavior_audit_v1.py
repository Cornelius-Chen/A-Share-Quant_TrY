...
from a_share_quant.strategy.v114h_cpo_promoted_sizing_behavior_audit_v1 import (
    ...
    write_v114h_cpo_promoted_sizing_behavior_audit_report,
)
...
def main() -> None:
    ...
    output_path = write_v114h_cpo_promoted_sizing_behavior_audit_report(
        reports_dir=repo_root / "reports" / "analysis",
        report_name="v114h_cpo_promoted_sizing_behavior_audit_v1",
        result=result,
    )
    print(output_path)
