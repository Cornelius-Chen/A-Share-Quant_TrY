...
from a_share_quant.strategy.v113x_probability_expectancy_sizing_framework_review_v1 import (
    ...
    load_json_report,
    write_v113x_probability_expectancy_sizing_framework_review_report,
)
...
def main() -> None:
    ...
    output_path = write_v113x_probability_expectancy_sizing_framework_review_report(
        reports_dir=repo_root / "reports" / "analysis",
        report_name="v113x_probability_expectancy_sizing_framework_review_v1",
        result=result,
    )
    print(output_path)
