...
from a_share_quant.strategy.v114i_cpo_existing_info_vector_excavation_review_v1 import (
    ...
    write_v114i_cpo_existing_info_vector_excavation_review_report,
)
...
def main() -> None:
    ...
    output_path = write_v114i_cpo_existing_info_vector_excavation_review_report(
        reports_dir=repo_root / "reports" / "analysis",
        report_name="v114i_cpo_existing_info_vector_excavation_review_v1",
        result=result,
    )
    print(output_path)
