...
from a_share_quant.strategy.v113w_cpo_under_exposure_attribution_review_v1 import (
    ...
    load_json_report,
    write_v113w_cpo_under_exposure_attribution_review_report,
)
...
def main() -> None:
    ...
    output_path = write_v113w_cpo_under_exposure_attribution_review_report(
        reports_dir=repo_root / "reports" / "analysis",
        report_name="v113w_cpo_under_exposure_attribution_review_v1",
        result=result,
    )
    print(output_path)
