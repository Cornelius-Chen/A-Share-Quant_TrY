...
from a_share_quant.strategy.v114d_cpo_stable_zone_replay_injection_v1 import (
    ...
    write_v114d_cpo_stable_zone_replay_injection_report,
)
...
def main() -> None:
    ...
    output_path = write_v114d_cpo_stable_zone_replay_injection_report(
        reports_dir=repo_root / "reports" / "analysis",
        report_name="v114d_cpo_stable_zone_replay_injection_v1",
        result=result,
    )
    print(output_path)
