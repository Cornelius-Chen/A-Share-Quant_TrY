...
class MaterializedAShareInternalHotNewsProgramRuntimeStackControlLoopRuntimeEnvelopeChangeSignalV1:
    summary: dict[str, Any]
    rows: list[dict[str, Any]]


class MaterializeAShareInternalHotNewsProgramRuntimeStackControlLoopRuntimeEnvelopeChangeSignalV1:
    def __init__(self, repo_root: Path) -> None:
        ...
        self.history_path = (
            ...
            / "info_center"
            / "serving_registry"
            / "a_share_internal_hot_news_program_runtime_stack_control_loop_runtime_envelope_history_v1.csv"
        )
        self.output_path = (
            repo_root
            / "data"
            ...
            / "info_center"
            / "time_slices"
            / "a_share_internal_hot_news_program_runtime_stack_control_loop_runtime_envelope_change_signal_v1.csv"
        )
        self.registry_path = (
            repo_root
            / "data"
            ...
            / "info_center"
            / "serving_registry"
            / "a_share_internal_hot_news_program_runtime_stack_control_loop_runtime_envelope_change_signal_registry_v1.csv"
        )
    ...
    def materialize(self) -> MaterializedAShareInternalHotNewsProgramRuntimeStackControlLoopRuntimeEnvelopeChangeSignalV1:
        ...
        row = {
            "runtime_stack_runtime_envelope_change_signal_id": "internal_hot_news_program_runtime_stack_control_loop_runtime_envelope_change_latest",
            ...
            "delivery_state": "runtime_stack_control_loop_runtime_envelope_change_signal_ready",
        }
        ...
        self._write_csv(
            ...
            [
                {
                    "view_id": "internal_hot_news_program_runtime_stack_control_loop_runtime_envelope_change_signal",
        ...
        summary = {
            ...
            "authoritative_output": "a_share_internal_hot_news_program_runtime_stack_control_loop_runtime_envelope_change_signal_materialized",
        }
        return MaterializedAShareInternalHotNewsProgramRuntimeStackControlLoopRuntimeEnvelopeChangeSignalV1(
            summary=summary,
            rows=[row],
        )
...
def main() -> None:
    ...
    result = MaterializeAShareInternalHotNewsProgramRuntimeStackControlLoopRuntimeEnvelopeChangeSignalV1(repo_root).materialize()
