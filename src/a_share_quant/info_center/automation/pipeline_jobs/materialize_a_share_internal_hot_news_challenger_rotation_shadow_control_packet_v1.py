...
class MaterializedAShareInternalHotNewsChallengerRotationShadowControlPacketV1:
    summary: dict[str, Any]
    rows: list[dict[str, Any]]


class MaterializeAShareInternalHotNewsChallengerRotationShadowControlPacketV1:
    def __init__(self, repo_root: Path) -> None:
        ...
        self.shadow_snapshot_path = base / "a_share_internal_hot_news_challenger_rotation_shadow_snapshot_v1.csv"
        self.output_path = base / "a_share_internal_hot_news_challenger_rotation_shadow_control_packet_v1.csv"
        self.registry_path = serving / "a_share_internal_hot_news_challenger_rotation_shadow_control_packet_registry_v1.csv"

    def materialize(self) -> MaterializedAShareInternalHotNewsChallengerRotationShadowControlPacketV1:
        control_packet = _read_csv(self.control_packet_path)[0]
        shadow_snapshot = _read_csv(self.shadow_snapshot_path)[0]

        row = {
            "challenger_rotation_shadow_control_packet_id": "internal_hot_news_challenger_rotation_shadow_control_packet_latest",
            ...
            "shadow_control_mode": "challenger_rotation_shadow_control_only",
            "shadow_control_state": "challenger_rotation_shadow_control_packet_ready",
        }
        ...
        _write_csv(
            ...
            [
                {
                    "view_id": "internal_hot_news_challenger_rotation_shadow_control_packet",
        ...
        summary = {
            ...
            "authoritative_output": "a_share_internal_hot_news_challenger_rotation_shadow_control_packet_materialized",
        }
        return MaterializedAShareInternalHotNewsChallengerRotationShadowControlPacketV1(summary=summary, rows=[row])


def main() -> None:
    repo_root = Path(__file__).resolve().parents[4]
    result = MaterializeAShareInternalHotNewsChallengerRotationShadowControlPacketV1(repo_root).materialize()
