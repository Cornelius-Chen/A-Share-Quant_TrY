...
class MaterializedAShareInternalHotNewsProgramOrchestrationLoopSignalChangeV1:
    summary: dict[str, Any]
    rows: list[dict[str, Any]]


class MaterializeAShareInternalHotNewsProgramOrchestrationLoopSignalChangeV1:
    def __init__(self, repo_root: Path) -> None:
        ...
        self.history_path = (
            ...
            / "info_center"
            / "serving_registry"
            / "a_share_internal_hot_news_program_orchestration_loop_signal_history_v1.csv"
        )
        self.output_path = (
            repo_root
            / "data"
            ...
            / "info_center"
            / "time_slices"
            / "a_share_internal_hot_news_program_orchestration_loop_signal_change_v1.csv"
        )
        self.registry_path = (
            repo_root
            / "data"
            ...
            / "info_center"
            / "serving_registry"
            / "a_share_internal_hot_news_program_orchestration_loop_signal_change_registry_v1.csv"
        )
    ...
    def materialize(self) -> MaterializedAShareInternalHotNewsProgramOrchestrationLoopSignalChangeV1:
        ...
        row = {
            "orchestration_loop_signal_change_id": "internal_hot_news_program_orchestration_loop_signal_change_latest",
            "orchestration_loop_signal_mode_change": loop_signal_mode_change,
            ...
            "delivery_state": "program_orchestration_loop_signal_change_ready",
        }
        ...
        self._write_csv(
            ...
            [
                {
                    "view_id": "internal_hot_news_program_orchestration_loop_signal_change",
        ...
        summary = {
            ...
            "authoritative_output": "a_share_internal_hot_news_program_orchestration_loop_signal_change_materialized",
        }
        return MaterializedAShareInternalHotNewsProgramOrchestrationLoopSignalChangeV1(summary=summary, rows=[row])


def main() -> None:
    repo_root = Path(__file__).resolve().parents[4]
    result = MaterializeAShareInternalHotNewsProgramOrchestrationLoopSignalChangeV1(repo_root).materialize()
