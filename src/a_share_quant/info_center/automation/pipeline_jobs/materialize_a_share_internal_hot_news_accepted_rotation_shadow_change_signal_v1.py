...
class MaterializedAShareInternalHotNewsAcceptedRotationShadowChangeSignalV1:
    summary: dict[str, Any]
    rows: list[dict[str, Any]]


class MaterializeAShareInternalHotNewsAcceptedRotationShadowChangeSignalV1:
    def __init__(self, repo_root: Path) -> None:
        ...
        self.shadow_control_packet_path = base / "a_share_internal_hot_news_accepted_rotation_shadow_control_packet_v1.csv"
        self.output_path = base / "a_share_internal_hot_news_accepted_rotation_shadow_change_signal_v1.csv"
        self.registry_path = (
            repo_root
            / "data"
            / "reference"
            / "info_center"
            / "serving_registry"
            / "a_share_internal_hot_news_accepted_rotation_shadow_change_signal_registry_v1.csv"
        )

    def materialize(self) -> MaterializedAShareInternalHotNewsAcceptedRotationShadowChangeSignalV1:
        ...
        row = {
            "accepted_rotation_shadow_change_signal_id": "internal_hot_news_accepted_rotation_shadow_change_signal_latest",
            ...
            "rotation_change_state": "explicit_shadow_rotation_delta",
        }
        ...
        _write_csv(
            ...
            [
                {
                    "view_id": "internal_hot_news_accepted_rotation_shadow_change_signal",
        ...
        summary = {
            ...
            "top_watch_symbol_change": top_watch_symbol_change,
            "signal_priority": signal_priority,
            "authoritative_output": "a_share_internal_hot_news_accepted_rotation_shadow_change_signal_materialized",
        }
        return MaterializedAShareInternalHotNewsAcceptedRotationShadowChangeSignalV1(summary=summary, rows=[row])


def main() -> None:
    repo_root = Path(__file__).resolve().parents[4]
    result = MaterializeAShareInternalHotNewsAcceptedRotationShadowChangeSignalV1(repo_root).materialize()
