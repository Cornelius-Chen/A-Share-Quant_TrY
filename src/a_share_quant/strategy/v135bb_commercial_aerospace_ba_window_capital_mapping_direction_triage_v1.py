...
class V135BBCommercialAerospaceBAWindowCapitalMappingDirectionTriageV1Report:
...
class V135BBCommercialAerospaceBAWindowCapitalMappingDirectionTriageV1Analyzer:
    ...
    def analyze(self) -> V135BBCommercialAerospaceBAWindowCapitalMappingDirectionTriageV1Report:
        ...
        triage_rows = [
            {
                ...
                "recommendation": "allow_negative_training_for_capital_mapping_diffusion_without_structure",
            }
            for row in rows
        ]
        summary = {
        ...
        return V135BBCommercialAerospaceBAWindowCapitalMappingDirectionTriageV1Report(
            summary=summary,
...
def write_report(
    *,
    reports_dir: Path,
    report_name: str,
    result: V135BBCommercialAerospaceBAWindowCapitalMappingDirectionTriageV1Report,
) -> Path:
...
def main() -> None:
    ...
    output_path = write_report(
        ...
        report_name="v135bb_commercial_aerospace_ba_window_capital_mapping_direction_triage_v1",
        result=result,
    )
    print(output_path)
