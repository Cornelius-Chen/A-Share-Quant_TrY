...
class V133UCommercialAerospacePointInTimeBroaderHitFeedReport:
...
class V133UCommercialAerospacePointInTimeBroaderHitFeedAnalyzer:
    def __init__(self, repo_root: Path) -> None:
        ...
        self.output_csv = (
            repo_root / "data" / "training" / "commercial_aerospace_point_in_time_broader_hit_feed_v1.csv"
        )

    def analyze(self) -> V133UCommercialAerospacePointInTimeBroaderHitFeedReport:
        ...
        for hit in hit_rows:
            ...
            symbol = hit["symbol"]
            zip_path = self.monthly_root / hit["month_bucket"] / f"{trade_date}_1min.zip"
            ...
            for minute_index, row in enumerate(first_60, start=1):
                ...
                output_row = {
                    ...
                    "symbol": symbol,
                    "predicted_tier": hit["predicted_tier"],
                    "month_bucket": hit["month_bucket"],
        ...
        acceptance_rows = [
            {
                "acceptance_item": "broader_hit_session_count",
                "status": "pass",
                "detail": f"{len(session_rows)} broader hit sessions materialized",
            },
            {
        ...
        summary = {
            "acceptance_posture": "freeze_v133u_commercial_aerospace_point_in_time_broader_hit_feed_v1",
            ...
            "authoritative_output": "commercial_aerospace_point_in_time_broader_hit_feed_ready_for_phase_1_extension_audit",
        }
        interpretation = [
            "V1.33U extends phase_1_visibility from the canonical seed surface to the broader 24 hit sessions.",
            "The broader feed is still shadow-only and keeps the same lineage discipline, but it deliberately does not reopen simulation or replay work.",
        ]
        return V133UCommercialAerospacePointInTimeBroaderHitFeedReport(
            summary=summary,
...
def write_report(
    *,
    reports_dir: Path,
    report_name: str,
    result: V133UCommercialAerospacePointInTimeBroaderHitFeedReport,
) -> Path:
