...
class V12V5RefreshManifestReport:
...
class V12V5RefreshManifestAnalyzer:
    """Audit whether the v5 refresh manifest obeys frozen carry/persistence training-gap criteria."""
    ...
    def analyze(
        ...
        *,
        ...
        summary = {
            ...
            "ready_to_bootstrap_market_research_v5_carry_row_diversity_refresh": ready_to_bootstrap,
        }
        interpretation = [
            "The v5 refresh manifest should satisfy the new training-gap-aware criteria gate.",
            "That means every symbol must stay new versus the combined reference base and must enter with an explicit true-carry or clean-persistence hypothesis.",
            "Pure opening-led clone logic is not an acceptable primary admission reason for this v5 refresh.",
        ]
        return V12V5RefreshManifestReport(
            summary=summary,
...
def write_v12_v5_refresh_manifest_report(
    *,
    reports_dir: Path,
    report_name: str,
    result: V12V5RefreshManifestReport,
) -> Path:
