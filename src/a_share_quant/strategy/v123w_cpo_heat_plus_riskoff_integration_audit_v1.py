...
class V123WCpoHeatPlusRiskoffIntegrationAuditReport:
...
class V123WCpoHeatPlusRiskoffIntegrationAuditAnalyzer:
    ...
    def _load_overlay_orders_by_exec(self, *, trade_dates: list[datetime.date]) -> dict[str, list[dict[str, Any]]]:
        v120e_payload = load_json_report(
    ...
    def _load_riskoff_signals(
        ...
        *,
        ...
        v121j_payload = load_json_report(
    ...
    def analyze(self) -> V123WCpoHeatPlusRiskoffIntegrationAuditReport:
        ...
        variant_defs = [
            ...
            {
                "variant_name": "strict_heat_reference",
            ...
            {
                "variant_name": "balanced_plus_riskoff_q75_r25",
                "symbol_cap_ratio": 0.30,
                "gross_cap_ratio": 0.70,
                "cash_floor_ratio": 0.25,
            ...
            {
                "variant_name": "balanced_plus_riskoff_q85_r25",
                "symbol_cap_ratio": 0.30,
                "gross_cap_ratio": 0.70,
                "cash_floor_ratio": 0.25,
            ...
            {
                "variant_name": "balanced_plus_riskoff_q85_r35",
                "symbol_cap_ratio": 0.30,
                "gross_cap_ratio": 0.70,
                "cash_floor_ratio": 0.25,
                "riskoff_quantile": "q85",
            ...
            {
                "variant_name": "strict_plus_riskoff_q75_r25",
                "symbol_cap_ratio": 0.25,
                "gross_cap_ratio": 0.60,
                "cash_floor_ratio": 0.35,
                "riskoff_quantile": "q75",
            ...
            {
                "variant_name": "strict_plus_riskoff_q85_r25",
                "symbol_cap_ratio": 0.25,
                "gross_cap_ratio": 0.60,
                "cash_floor_ratio": 0.35,
                "riskoff_quantile": "q85",
            ...
            {
                "variant_name": "strict_plus_riskoff_q85_r35",
                "symbol_cap_ratio": 0.25,
                "gross_cap_ratio": 0.60,
                "cash_floor_ratio": 0.35,
                "riskoff_quantile": "q85",
        ...
        best_tradeoff = max(variant_rows, key=lambda row: _to_float(row["final_equity"]) - 2_500_000 * _to_float(row["max_drawdown"]))
        summary = {
            "acceptance_posture": "freeze_v123w_cpo_heat_plus_riskoff_integration_audit_v1",
            ...
            "recommended_next_posture": "triage_heat_plus_riskoff_execution_audit_before_any_more_risk_family_work",
        }
        interpretation = [
            "V1.23W integrates the frozen control priority order into one execution audit: heat guardrails first, then a broad reduce prior.",
            "This is still research-only because board_risk_off_reduce_score remains candidate-only and highly broad.",
            "The goal is to see whether partial de-risk on top of heat caps can compress drawdowns further without destroying the overlay's return profile.",
        ]
        return V123WCpoHeatPlusRiskoffIntegrationAuditReport(
            summary=summary,
...
def write_report(
    *,
    reports_dir: Path,
    report_name: str,
    result: V123WCpoHeatPlusRiskoffIntegrationAuditReport,
) -> Path:
...
def main() -> None:
    ...
    analyzer = V123WCpoHeatPlusRiskoffIntegrationAuditAnalyzer(repo_root=repo_root)
    result = analyzer.analyze()
    output_path = write_report(
        reports_dir=repo_root / "reports" / "analysis",
        report_name="v123w_cpo_heat_plus_riskoff_integration_audit_v1",
        result=result,
    )
    print(output_path)
