...
class V16PhaseClosureCheckReport:
...
class V16PhaseClosureCheckAnalyzer:
    """Check whether V1.6 has reached a lawful bounded closure point."""
    ...
    def analyze(
        ...
        *,
    ...
    ) -> V16PhaseClosureCheckReport:
        charter_summary = dict(phase_charter_payload.get("summary", {}))
        review_summary = dict(feature_stability_review_payload.get("summary", {}))
        phase_summary = dict(phase_check_payload.get("summary", {}))

        success_criteria_met = (
            bool(charter_summary.get("do_open_v16_now"))
            and review_summary.get("continue_provisional_candidacy_count", 0) >= 1
            and not bool(phase_summary.get("promote_retained_now"))
        )

        summary = {
            "acceptance_posture": "close_v16_as_bounded_stability_review_success",
            "v16_success_criteria_met": success_criteria_met,
            ...
            "enter_v16_waiting_state_now": success_criteria_met,
            "promote_retained_now": False,
            "open_local_regime_phase_now": False,
            "recommended_next_posture": "preserve_v16_stability_results_and_wait_for_owner_phase_switch_or_trigger",
        }
        evidence_rows = [
            {
                ...
                "actual": {
                    ...
                    "do_open_v16_now": charter_summary.get("do_open_v16_now"),
                },
                "reading": "V1.6 opened lawfully as a bounded stability review phase.",
            },
            {
                ...
                "reading": "The current review answered which provisional candidates remain stable enough to stay alive.",
            },
            {
                ...
                "reading": "The branch remains below promotion threshold, so closure should preserve stability-review results rather than force promotion or new branches.",
            },
        ]
        interpretation = [
            "V1.6 has now answered its core question: which provisional candidacy features remain stable enough to stay alive under bounded review.",
        ...
        return V16PhaseClosureCheckReport(
            summary=summary,
...
def write_v16_phase_closure_check_report(
    *,
    reports_dir: Path,
    report_name: str,
    result: V16PhaseClosureCheckReport,
) -> Path:
