...
class V126OCommercialAerospacePhaseGeometryWalkForwardShadowReplayReport:
...
class V126OCommercialAerospacePhaseGeometryWalkForwardShadowReplayAnalyzer:
    ...
    def analyze(self) -> V126OCommercialAerospacePhaseGeometryWalkForwardShadowReplayReport:
        ...
        summary = {
            "acceptance_posture": "freeze_v126o_commercial_aerospace_phase_geometry_walk_forward_shadow_replay_v1",
            ...
            "authoritative_status": "commercial_aerospace_phase_geometry_walk_forward_shadow_replay_candidate",
        }
        interpretation = [
            "V1.26O is the first lawful walk-forward shadow replay that uses phase-geometry relabeling and only matured labels at each trade date.",
            "This tests whether the 11-14 to 12-23 preheat segment can become real training support instead of a post-hoc story.",
        ]
        return V126OCommercialAerospacePhaseGeometryWalkForwardShadowReplayReport(
            summary=summary,
...
def write_report(*, reports_dir: Path, report_name: str, result: V126OCommercialAerospacePhaseGeometryWalkForwardShadowReplayReport) -> Path:
...
def main() -> None:
    ...
    output_path = write_report(
        ...
        report_name="v126o_commercial_aerospace_phase_geometry_walk_forward_shadow_replay_v1",
        result=result,
    )
    print(output_path)
